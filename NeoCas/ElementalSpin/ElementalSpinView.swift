...
struct ElementalSpinView: View {
    @StateObject var scratchModel =  ElementalSpinViewModel()
    @State var showAlert = false
    @Environment(\.presentationMode) var presentationMode
    let symbolArray = [Symbol(image: "elemental1", value: "100"),
                                    ...
                                    VStack(spacing: 10) {
                                        VStack(spacing: 15) {
                                                    ...
                                                    HStack(spacing: 0) {
                                                        ForEach(0..<5, id: \.self) { col in
                                                            Rectangle()
                                                                ...
                                                                .shadow(
                                                                    color: scratchModel.winningPositions.contains(where: { $0.row == row && $0.col == col }) ? Color(red: 146/255, green: 110/255, blue: 18/255) : .clear,
                                            ...
                                            VStack {
                                                ...
                                                CustomTextFiled(text: $scratchModel.betString, placeholder: "")
                                                    .padding(.horizontal)
...
//                                                    .padding(.horizontal)
            ...
            if scratchModel.isWin {
                ZStack {
                    ...
                    VStack(spacing: 60) {
                        Image(.elementalWinLabel)
                            .resizable()
                            .aspectRatio(contentMode: .fit)
                            .frame(width: 310, height: 215)
                        
                        Rectangle()
                            .fill(Color(red: 153/255, green: 255/255, blue: 2/255))
                            .frame(width: 250, height: 52)
                            .overlay {
                                RoundedRectangle(cornerRadius: 8)
                                    .stroke(Color(red: 94/255, green: 247/255, blue: 103/255), lineWidth: 3)
                                    .overlay {
                                        HStack(spacing: 5) {
                                            Text("+\(scratchModel.win)")
                                                .FontMedium(size: 40, color: .black)
                            ...
                            .cornerRadius(8)
                            .shadow(color: Color(red: 153/255, green: 255/255, blue: 2/255), radius: 10)
