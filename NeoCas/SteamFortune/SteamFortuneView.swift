...
struct SteamFortuneView: View {
    @StateObject var scratchModel =  SteamFortuneViewModel()
    @Environment(\.presentationMode) var presentationMode
    @State var showAlert = false
    let symbolArray = [Symbol(image: "steam1", value: "100"),
                    ...
                    VStack(spacing: 15) {
                        ...
                        ScrollView(showsIndicators: false) {
                            Rectangle()
                                .fill(LinearGradient(
                                    colors: [
                                        Color(red: 171/255, green: 193/255, blue: 194/255),
                                        Color(red: 162/255, green: 174/255, blue: 185/255),
                                        Color(red: 152/255, green: 110/255, blue: 152/255),
                                        Color(red: 68/255, green: 135/255, blue: 101/255),
                                        Color(red: 86/255, green: 56/255, blue: 115/255)
                                    ],
                                    startPoint: .topLeading,
                                    endPoint: .bottomTrailing
                                ))
                                ...
                                .overlay {
                                    VStack(spacing: 10) {
                                        VStack(spacing: 15) {
                                            VStack {
                                                SteamPlaceholder(text: "YOUR GUESS")
                                            ...
                                            VStack {
                                                SteamPlaceholder(text: "BET AMOUNT")
                                                
                                                CustomTextFiled3(text: $scratchModel.betString, placeholder: "")
                                                    .padding(.horizontal)
//                                                Rectangle()
//                                                    .fill(LinearGradient(
//                                                        colors: [
...
//                                                    .padding(.horizontal)
                                            ...
                                            VStack {
                                                SteamPlaceholder(text: "SYMBOL VALUES(match 3)")
            ...
            if scratchModel.isWin {
                ZStack {
                    ...
                    VStack(spacing: 60) {
                        ...
                        Rectangle()
                            .fill(Color(red: 13/255, green: 33/255, blue: 255/255))
                            .frame(width: 250, height: 52)
                            .overlay {
                                RoundedRectangle(cornerRadius: 8)
                                    .stroke(Color(red: 12/255, green: 118/255, blue: 239/255), lineWidth: 3)
                                    .overlay {
                                        HStack(spacing: 5) {
                            ...
                            .cornerRadius(8)
                            .shadow(color: Color(red: 13/255, green: 33/255, blue: 255/255), radius: 10)
